...
2. On the Today screen, notice the Weather Observatory hero, moving lens, carry seed, time-aware garden tone, weather instruments, pressure layers, local soundscape console, and next seed.
...
7. Tap Continue.
8. Confirm the privacy ritual turns typed words into storm fragments without repeating the full reflection.
9. Review the generated Growth Action and move several thought fragments and live storm words through Now, Later, and Let go by tapping or dragging them:
...
14. Scrub Week Shape and confirm the seven days read as emotional terrain with mood points, lane marks, and day landmarks.
...
17. Inspect Emotional Atlas and tap the newest seed; confirm both avoid reflection text and the seed detail shows a Memory Without Text stamp.
...
The main creative idea is that pressure changes form. Instead of showing a generic checklist, BloomMind begins with a Weather Observatory: a storm of student-life fragments such as deadlines, grades, messages, and "too much" becomes an inner sky with pressure layers, instruments, and optional local sound cues. As the student calibrates loud/quiet and heavy/light, then writes, the storm surfaces live keywords and theme-colored weather. A privacy ritual turns the private reflection into fragments without replaying the full text. A check-in lets the student pull those fragments into Now, Later, and Let go, where each lane has different emotional physics: Now lands with weight, Later hovers, and Let go becomes air. Storm Surgery makes that transformation visible around a storm core. The feeling then transforms through a drag-to-soil ritual. Each planted seed remembers the mood, local theme, calibration shape, and sorting choice, so Now becomes roots, Later becomes buds, and Let go becomes open air in the garden world. Surface, scrub-able Week Shape, Emotional Atlas, X-Ray, Garden Map views, Memory Without Text stamps, and the "What changed because of me?" panel make those consequences explorable. After seven seeds, the Weekly Bloom reveal turns the whole week into a named pressure constellation, animated transformation, artifact crafting, emotional literacy and vocabulary unlocks, final story mode, Week Artifact, closing ritual, next-week seed, and private museum shelf.
...
- Confirm Award Demo Director captions explain the 90-second story path.
- Confirm the weekly review card and Weekly Bloom payoff summarize the completed sample week.
- Confirm the time-aware garden tone changes the Home garden context.
- Confirm the Inner Garden World shows roots, buds, open air, and mood weather.
- Confirm the "What changed because of me?" panel explains the latest lane consequence.
- Confirm Week Shape shows the emotional terrain line, mood points, lane marks, day landmarks, and scrubbed day focus.
- Confirm Emotional Atlas shows rare bloom cards without reflection text.
...
- Confirm seed memory cards include a Memory Without Text stamp.
- Confirm Weekly Bloom gives the completed week a pressure constellation name.
...
- Confirm Weekly Bloom includes emotional vocabulary unlocks and final story mode.
- Confirm Weekly Bloom lets the completed week be Pressed, Released, or Connected before archive.
- Confirm the carry-forward line appears as a visible carry seed on the Home lens.
...
2. Tap Enter the Storm, drag the Emotional Calibration Ring, and select Stressed, Overwhelmed, Focused, or another one of the eight moods.
3. Either leave Reflection empty to test the quick path, use Wordless Mode, or type `I have a project deadline and too much to finish.` to test live storm typing and local theme detection.
...
9. Scrub Week Shape, inspect Emotional Atlas, switch the garden to X-Ray, tap Garden Map zones and the newest plant, then confirm the private memory card and Memory Without Text stamp avoid reflection text.
10. Confirm the "What changed because of me?" panel and time-aware garden tone are visible on Home.
11. Tap Preview Award Demo and confirm the Award Demo Theatre captions, Week memory strip, weekly review card, Inner Garden World, Week Shape, Emotional Atlas, Garden X-Ray, Garden Map, and Weekly Bloom payoff show a complete sample week without changing real check-ins.
12. Confirm the Weekly Bloom payoff includes the constellation reveal, pressure constellation name, animated time-lapse, week story, artifact crafting, literacy and vocabulary unlocks, final story mode, Week Artifact, closing ritual, next-week seed, privacy note, and private museum shelf.
13. Rotate or resize to a wider iPad/Mac review width and confirm Home uses the two-column storm-and-garden layout.
14. Switch the device or simulator to dark appearance and confirm text, panels, storm scenes, buttons, and garden notes remain readable.
15. Turn on Reduce Motion and confirm the garden remains understandable without relying on animation.
16. Turn on a larger text size and confirm the main flow remains scrollable and readable.
...
- ZIP size: 86,098 bytes after the Stage 13 Soul Details package refresh.
- Contents: `BloomMind.swiftpm/Package.swift` plus `BloomMind.swiftpm/Sources/`.
- The generated ZIP excludes `.DS_Store` and `__MACOSX`.
- The generated `.swiftpm` package includes the Stage 13 Soul Details source files.
...
- `Unable to open mach-O ... RenderBox.framework ... default.metallib Error:2` and `ViewBridge to RemoteViewService Terminated ... Code=18` are usually benign Xcode/SwiftUI preview or remote view service messages if the app keeps running.
- Investigate them only if the app window or preview actually crashes, goes blank, or stops accepting input.
...
- The calibration ring, live storm, privacy ritual, emotional physics sorting, focus sprout, inner garden world, Garden X-Ray, drag-to-plant ritual, garden map, seed memory cards, memory stamps, vocabulary unlocks, final story mode, and Weekly Bloom payoff are local SwiftUI and use only mood, theme, calibration shape, and lane metadata after planting, not private reflection text.
